...
<figure class="wp-block-image alignwide size-full is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/building-exterior.webp" alt="<?php echo esc_attr_e( 'Building exterior in Toronto, Canada', 'chl-houseshare' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/tourist-and-building.webp" alt="<?php echo esc_attr_e( 'Tourist taking photo of a building', 'chl-houseshare' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"is-style-rounded"} -->
<figure class="wp-block-image size-large is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/windows.webp" alt="<?php echo esc_attr_e( 'Windows of a building in Nuremberg, Germany', 'chl-houseshare' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
